...
feature "User views a question's details" do
  ...
  it "displays question details when question is clicked" do
    ...
    question = Question.create(title: "Are pigs cuter with other animals or alone?",
    ...
    click_on "Are pigs cuter with other animals or alone?"

    expect(page).to have_content "Are pigs cuter with other animals or alone?", "I am a person who wants to know about cute animals
    and I want to know whether people think capybaras are cuter when interacting with
    other animals than they are on their own."
  end
end
